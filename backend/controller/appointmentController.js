...
export const getMyAppointments = async (req, res) => {
  try {
    ...
    const appointments = await Appointment.find({ doctorId })
      .populate("patientId", "firstName lastName") // populate patient name
      .select("patientId appointment_date status") // only required fields
      .sort({ appointment_date: 1 }); // earliest first
